...
**Entry commands**:
- `/harnessdesign-start` — Start a new design task (verbal description / upload PRD / both)
- `/harnessdesign-migrate` — Import existing design artifacts from other AI tools (ChatGPT, Claude, Copilot, etc.) into HarnessDesign. The migration flow analyzes imported materials, converts them to HD format, fills gaps through targeted dialogue, and dispatches to the appropriate phase.
...
│   │   ├── migration-skill.md            # Context migration from external AI tools
