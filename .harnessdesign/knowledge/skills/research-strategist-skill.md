...
```
[ACTION] 创建 .harnessdesign/memory/sessions/phase2-insight-cards.md（初始为空）
...
```
[ACTION] 写入 .harnessdesign/memory/sessions/phase2-topic-{domain}-{n}.md
...
```
[ACTION] 将 InsightCard 追加到 .harnessdesign/memory/sessions/phase2-insight-cards.md
...
2. 读取 .harnessdesign/memory/sessions/phase2-insight-cards.md（所有已归档 InsightCards，~2-3k tokens）
...
按 .harnessdesign/knowledge/rules/phase-summary-cards.md 中的 "Phase 2 → Phase 3" 模板
...
```
[ACTION] 归档剩余内容到 .harnessdesign/memory/sessions/phase2-research.md
